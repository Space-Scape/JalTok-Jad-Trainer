...
func OnHealerClicked():
	if get_tree().get_root().get_child(2).has_node("Healer"):
		...
		if Globals.attHealer1 == true and !Globals.attHealer2 and !Globals.attHealer3 and !Globals.attHealer4 and !Globals.attHealer5 and !Globals.attHealer6:
...
func OnHealer2Clicked():
	if get_tree().get_root().get_child(2).has_node("Healer2"):
		...
		if Globals.attHealer2 == true and !Globals.attHealer1 and !Globals.attHealer3 and !Globals.attHealer4 and !Globals.attHealer5 and !Globals.attHealer6:
...
func OnHealer3Clicked():
	if get_tree().get_root().get_child(2).has_node("Healer3"):
		...
		if Globals.attHealer3 == true and !Globals.attHealer1 and !Globals.attHealer2 and !Globals.attHealer4 and !Globals.attHealer5 and !Globals.attHealer6:
...
func OnHealer4Clicked():
	if get_tree().get_root().get_child(2).has_node("Healer4"):
		...
		if Globals.attHealer4 == true and !Globals.attHealer1 and !Globals.attHealer2 and !Globals.attHealer3 and !Globals.attHealer5 and !Globals.attHealer6:
			target = healer4.transform.origin
			min_distance = 25
func OnHealer5Clicked():
	if get_tree().get_root().get_child(2).has_node("Healer5"):
		var healer5 = get_tree().get_root().get_child(2).get_node("Healer5")
		if Globals.attHealer5 == true and !Globals.attHealer1 and !Globals.attHealer2 and !Globals.attHealer3 and !Globals.attHealer4 and !Globals.attHealer6:
			target = healer5.transform.origin
			min_distance = 25
func OnHealer6Clicked():
	if get_tree().get_root().get_child(2).has_node("Healer6"):
		var healer6 = get_tree().get_root().get_child(2).get_node("Healer6")
		if Globals.attHealer6 == true and !Globals.attHealer1 and !Globals.attHealer2 and !Globals.attHealer3 and !Globals.attHealer4 and !Globals.attHealer5:
...
func _on_StaticBody_input_event(_camera, event, click_position, _click_normal, _shape_idx):
	if event is InputEventMouseButton:
		if event.button_index == BUTTON_LEFT and event.pressed:
			...
			if get_tree().get_root().get_child(2).has_node("JadR"):
